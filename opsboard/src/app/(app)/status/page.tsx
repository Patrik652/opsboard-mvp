...
export default function StatusPage() {
  return (
    <section>
      <div className="mb-6">
        <h1 className={pageTitleClassName}>Status</h1>
        <p className={mutedTextClassName}>Public-facing service health snapshot.</p>
      </div>
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className={mutedTextClassName}>All systems</div>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={service.name} className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
              <div className={mutedTextClassName}>{service.name}</div>
